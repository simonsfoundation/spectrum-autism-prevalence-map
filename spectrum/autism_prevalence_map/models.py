...
class studies(models.Model):
    ...
    meanincomeofparticipants = models.CharField(max_length=255, default='', blank=True, null=True, verbose_name='Mean Income of Participants')
    educationlevelofparticipants = models.CharField(max_length=255, default='', blank=True, null=True, verbose_name='Education Level of Participants')
